...
<p align="center">
  <img src="https://raw.githubusercontent.com/nautobot/nautobot-app-ssot-citrix-adm/develop/docs/images/icon-nautobot-ssot-citrix-adm.png" class="logo" height="200px">
  <br>
  <a href="https://github.com/nautobot/nautobot-app-ssot-citrix-adm/actions"><img src="https://github.com/nautobot/nautobot-app-ssot-citrix-adm/actions/workflows/ci.yml/badge.svg?branch=main"></a>
...
> Developer Note: Place the files in the `docs/images/` folder and link them using only full URLs from GitHub, for example: `![Overview](https://raw.githubusercontent.com/nautobot/nautobot-app-ssot-citrix-adm/develop/docs/images/app-overview.png)`. This absolute static linking is required to ensure the README renders properly in GitHub, the docs site, and any other external sites like PyPI.

More screenshots can be found in the [Using the App](https://docs.nautobot.com/projects/nautobot-ssot-citrix-adm/en/latest/user/app_use_cases/) page in the documentation. Here's a quick overview of some of the app's added functionality:

![](https://raw.githubusercontent.com/nautobot/nautobot-app-ssot-citrix-adm/develop/docs/images/placeholder.png)
...
You can find all the Markdown source for the App documentation under the [`docs`](https://github.com/nautobot/nautobot-app-ssot-citrix-adm/tree/develop/docs) folder in this repository. For simple edits, a Markdown capable editor is sufficient: clone the repository and edit away.
