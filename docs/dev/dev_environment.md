...
- `project_name`: the default docker compose project name (default: `nautobot_ssot_citrix_adm`)
...
#14 naming to docker.io/nautobot-ssot-citrix-adm/nautobot:latest-py3.7 done
```
...
Creating network "nautobot_ssot_citrix_adm_default" with the default driver
Creating volume "nautobot_ssot_citrix_adm_postgres_data" with default driver
Creating nautobot_ssot_citrix_adm_redis_1 ...
Creating nautobot_ssot_citrix_adm_docs_1  ...
Creating nautobot_ssot_citrix_adm_postgres_1 ...
Creating nautobot_ssot_citrix_adm_postgres_1 ... done
Creating nautobot_ssot_citrix_adm_redis_1    ... done
Creating nautobot_ssot_citrix_adm_nautobot_1 ...
Creating nautobot_ssot_citrix_adm_docs_1     ... done
Creating nautobot_ssot_citrix_adm_nautobot_1 ... done
Creating nautobot_ssot_citrix_adm_worker_1   ...
Creating nautobot_ssot_citrix_adm_worker_1   ... done
...
ee90fbfabd77   nautobot-ssot-citrix-adm/nautobot:latest-py3.7   "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               nautobot_ssot_citrix_adm_worker_1
b8adb781d013   nautobot-ssot-citrix-adm/nautobot:latest-py3.7   "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   nautobot_ssot_citrix_adm_nautobot_1
d64ebd60675d   nautobot-ssot-citrix-adm/nautobot:latest-py3.7   "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   nautobot_ssot_citrix_adm_docs_1
e72d63129b36   postgres:13-alpine               "docker-entrypoint.s…"   25 seconds ago   Up 19 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   nautobot_ssot_citrix_adm_postgres_1
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   nautobot_ssot_citrix_adm_redis_1
```
...
Stopping nautobot_ssot_citrix_adm_worker_1   ...
Stopping nautobot_ssot_citrix_adm_nautobot_1 ...
Stopping nautobot_ssot_citrix_adm_docs_1     ...
Stopping nautobot_ssot_citrix_adm_redis_1    ...
Stopping nautobot_ssot_citrix_adm_postgres_1 ...
Stopping nautobot_ssot_citrix_adm_worker_1   ... done
Stopping nautobot_ssot_citrix_adm_nautobot_1 ... done
Stopping nautobot_ssot_citrix_adm_postgres_1 ... done
Stopping nautobot_ssot_citrix_adm_redis_1    ... done
Stopping nautobot_ssot_citrix_adm_docs_1     ... done
Removing nautobot_ssot_citrix_adm_worker_1   ...
Removing nautobot_ssot_citrix_adm_nautobot_1 ...
Removing nautobot_ssot_citrix_adm_docs_1     ...
Removing nautobot_ssot_citrix_adm_redis_1    ...
Removing nautobot_ssot_citrix_adm_postgres_1 ...
Removing nautobot_ssot_citrix_adm_postgres_1 ... done
Removing nautobot_ssot_citrix_adm_docs_1     ... done
Removing nautobot_ssot_citrix_adm_worker_1   ... done
Removing nautobot_ssot_citrix_adm_redis_1    ... done
Removing nautobot_ssot_citrix_adm_nautobot_1 ... done
Removing network nautobot_ssot_citrix_adm_default
```
...
So for example, our plugin is named `nautobot-ssot-citrix-adm`, the command would most likely be `docker logs nautobot_ssot_citrix_adm_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
```python
namespace = Collection("nautobot_ssot_citrix_adm")
namespace.configure(
    {
        "nautobot_ssot_citrix_adm": {
            ...
...
Or set the `INVOKE_nautobot_ssot_citrix_adm_NAUTOBOT_VER` variable.
